...
export class AddReportPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private camera: Camera/*,private mediaCapture: MediaCapture, */,private platform:Platform,private filePath: FilePath,private f:File) {
...
/*getPicture(/*sourceType: PictureSourceType) {
  ...
  saveImgToFireStorage(){
    ...
    //  var noPic = this.pic_available;
      firebase.database().ref('/Events/').push({downloadUrl: this.imageURI,EventName:this.eventName,eventVenue:this.eventVenue, EventDate: this.eventDate,EventTime: this.eventTime, EventCategory: this.category});
      this.navCtrl.push("ViewEventPage");
    }
  }
